          ...
          <div className='absolute top-0 w-full h-full  flex flex-col justify-between p-1 pr-2 pt-2 pb-2 z-50' style={{height:'100%'}}>
            ...
            <div className='flex justify-between items-center w-full gap-2'>
                ...
                {postedBy?._id ===user?.googleId && (
                  ...
                  type='button'
                    className="bg-white p-2 rounded-full w-8 h-8 flex items-center justify-center text-dark opacity-70 hover:opacity-100 
                    hover:text-red-400 outline-none hover:shadow-md"
                  >
                      <AiTwotoneDelete/>
                  </button>
                ) }
